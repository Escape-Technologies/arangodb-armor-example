...
class ApolloCharacterLimitProtection extends ApolloProtection {
  ...
  protect() {
    ...
    return {
      plugins: [plugin({
        maxLength: (_this$config$characte2 = (_this$config$characte3 = this.config.characterLimit) === null || _this$config$characte3 === void 0 ? void 0 : _this$config$characte3.maxLength) !== null && _this$config$characte2 !== void 0 ? _this$config$characte2 : characterLimitDefaultOptions.maxLength
      })]
    };
  }
