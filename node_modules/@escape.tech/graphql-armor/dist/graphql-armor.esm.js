...
import { characterLimitDefaultOptions, characterLimitPlugin } from '@escape.tech/graphql-armor-character-limit';
...
class ApolloBlockFieldSuggestionProtection extends ApolloProtection {
  ...
  protect() {
    return {
      plugins: [plugin$1(this.config.blockFieldSuggestion ?? blockFieldSuggestionsDefaultOptions)]
    };
  }
...
class ApolloCharacterLimitProtection extends ApolloProtection {
  ...
  protect() {
    ...
    return {
      plugins: [plugin({
        maxLength: ((_this$config$characte = this.config.characterLimit) === null || _this$config$characte === void 0 ? void 0 : _this$config$characte.maxLength) ?? characterLimitDefaultOptions.maxLength
      })]
    };
  }
...
class ApolloCostLimitProtection extends ApolloProtection {
  ...
  protect() {
    return {
      validationRules: [costLimitRule(message => {
...
class ApolloMaxAliasesProtection extends ApolloProtection {
  ...
  protect() {
    return {
      validationRules: [maxAliasesRule(message => {
        throw new GraphQLError(message, {
          extensions: {
            code: 'BAD_USER_INPUT'
          }
...
class ApolloMaxDepthProtection extends ApolloProtection {
  ...
  protect() {
    return {
      validationRules: [maxDepthRule(message => {
        throw new GraphQLError(message, {
          extensions: {
            code: 'BAD_USER_INPUT'
          }
...
class ApolloMaxDirectivesProtection extends ApolloProtection {
  ...
  protect() {
    return {
      validationRules: [maxDirectivesRule(message => {
        throw new GraphQLError(message, {
          extensions: {
            code: 'BAD_USER_INPUT'
          }
